			...
			<div class="b-b nav-active-bg">
				<div class="row">
					<div class="col-sm-4">
						...
						<form>
                            <input type="hidden" id="ID" value="<?=$studcurr->ID?>" />
							<div class="form-group">
								...
								<select class="form-control select2" id="student" ui-jp="select2" ui-options="{theme: 'bootstrap'}">
									...
									if (!empty($student)) {
										?>
										<option value="<?=$student->ID?>"><?=$student->Lname?>, <?=$student->Fname?> <?=$student->Mname?></option>
										<?php
									}
									?>
								</select>
							...
							<div class="form-group">
								...
								<select class="form-control select2" id="curriculum" ui-jp="select2" ui-options="{theme: 'bootstrap'}">
									...
									if (!empty($curriculum)) {
										...
										?>
											<option value="<?=$value->ID?>" <?=($studcurr->CurriculumID == $value->ID) ? 'selected' : '' ?>><?=$value->Curriculum_name?></option>
										<?php
										}
									}
									?>
						...
						<button type="submit" class="btn btn-primary" id="studcurr_update">Submit</button>
					</div>
				</div>
			</div>
		</div>
